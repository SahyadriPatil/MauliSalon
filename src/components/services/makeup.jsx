    ...
    <>
     <div className="makeuphead">
        <div className="makeupmain">
          <h1 className="heading">MAKEUP <br/>SERVICES....!</h1>
        </div>
            ...
            >
              {
                <>
                  <div className="slider-card">
                    <div>
                      <img className="slider-card-image cardimg"
                        src={img5}
                        alt=""
                      />
                    </div>
                  ...
                  <div className="slider-card">
                    <img className="slider-card-image cardimg" src={img6} alt="" />
                   
                    <h5 className="tag">Makes you love yourself. </h5>
                  </div>
                  <div className="slider-card">
                    <img className="slider-card-image cardimg" src={img3} alt="" />
                    <h5 className="tag"> Let your beauty speak for you.</h5>
                  </div>
                  <div className="slider-card">
                    <img className="slider-card-image cardimg" src={img4} alt="" />
                    <h5 className="tag">   Bringing out the best in you. </h5>
                  </div>
                  <div className="slider-card">
                    <img className="slider-card-image cardimg" src={img1} alt="" />
                    <h5 className="tag">  Say yes to looking beautiful. </h5>
                  </div>
                  <div className="slider-card">
                    <img className="slider-card-image cardimg" src={img2} alt="" />
                    <h5 className="tag">  The glam every woman deserves. </h5>
          
                  </div>
                  <div className="slider-card">
                    <img className="slider-card-image cardimg" src={img7} alt="" />
